...
public class chin{
	...
	public static void selling(String username) {
		...
		System.out.printf ("2. Saltwater Fish\n");
		System.out.println("->");
		...
		for (int i =0; i<quantitySell;i++) {
			...
			if (type ==1) {
				...
				System.out.printf ("5. Golden Trevally\n");
				System.out.println("->");
				species = input.nextInt();
				switch(species) {
				case 1 :
	...
	public static void cancelTrade(int main) {
        System.out.println("");
